...
<body>
    ...
    <div class="content">
        <h1 class="dashboard">Data Mahasiswa</h1>
        <?php
        include './../koneksi.php';
        $searchKeyword = "";
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="pribadi-edit-akun.php?id=<?php echo $row['id']; ?>" class="btn">Edit</a>
                            <a href="pribadi-delete.php?id=<?php echo $row['id']; ?>" class="btn"
        ...
        <a href="pribadi-buat-akun.html" class="btn add-button">Create Data Mahasiswa</a>
